 ...
 */
class Administrateur extends \TeamBuilder\CovoiturageBundle\Entity\Administrateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'login', 'mdp', 'nom', 'prenom', 'idAdministrateur');
        }
    ...
    public function getIdAdministrateur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdAdministrateur', array());

        return parent::getIdAdministrateur();
    }
