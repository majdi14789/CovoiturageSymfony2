...
/* TestBundle:Home:AfficheReservationAnciennes.html.twig */
class __TwigTemplate_2e364ae92aad2e69b012582bb321f4b5ce6564cc5664cb36b810a8358653e2f2 extends Twig_Template
{
...
";
    ...
    <tr>
       ...
       <td>
         ...
         <a href = \" ";
            // line 32
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("AfficheDetailsReservationsAnciennes", array("idReservation" => $this->getAttribute((isset($context["res"]) ? $context["res"] : $this->getContext($context, "res")), "idReservation"), "idTrajet" => $this->getAttribute($this->getAttribute((isset($context["res"]) ? $context["res"] : $this->getContext($context, "res")), "idTrajet"), "idTrajet"))), "html", null, true);
            echo " \"> Consulter </a>   
        </td> 
...
";
    ...
    {
        return "TestBundle:Home:AfficheReservationAnciennes.html.twig";
    }
