...
/* TeamBuilderCovoiturageBundle::layout.html.twig */
class __TwigTemplate_ba09e6bc6c153cebb941019ee6c4da0047644ca75cf8ee3c214189ce458e7e12 extends Twig_Template
{
...
\t\t\t\t\t<form action=";
        ...
        echo ">
\t\t\t\t\t\t<span> Depart :</span>
\t\t\t\t\t\t<input id='villedepart1' class=\"dest\" type=\"text\" value=\"Ville Depart\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'Depart';}\">
                                                
                                                <span> Destination :</span>
\t\t\t\t\t\t<input id='villedestination1'class=\"dest\" type=\"text\" value=\"Ville Arrivee\" onfocus=\"this.value = '';\" onblur=\"if (this.value == '') {this.value = 'Destination';}\">
